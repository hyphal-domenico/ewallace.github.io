...
We are currently (November 2022) back "beyond level 0" as far as COVID-19 goes.
So there is no shift system for wet lab work.
...
* Weekly lab meetings, currently Wednesdays 09:30-11:00.
...
* Alternate Thursday mornings: Engineering Biology Open Centre Meeting (9:30 talks; attendance encouraged) - this is the community meeting for synthetic and systems biology colleagues
* Last Friday of the month: Engineering Biology happy hour (5pm drinks, 6pm Pizza; attendance rewarding - just restarted after COVID).  

There are [many interesting seminars in the school of biological sciences, listed on the website](https://www.ed.ac.uk/biology/news-events/events-and-seminars). Engineering Biology, ICMB, and infectious disease seminars are also listed there.
...
Currently (November 2022) most staff have access, most students don't.
PhD students should email Andrea Shulz in SBS finance office (and cc Edward if that helps).

### Grant budgets

Currently it's not possible to check grant budgets due to the People & Money debacle.
We don't know when they will be updated.

OLD: If you have a grant (e.g. consumables from PhD studentship), email Andrea Shulz in SBS finance office (and cc Edward) to be given access to [Webfirst](https://www.webfirst.fin.ed.ac.uk) to see grant budgets and spending.
...
* `synthsys-all` - the centre for engineering biology (formerly Synthsys) email list.
